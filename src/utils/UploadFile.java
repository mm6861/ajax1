...
public class UploadFile {
    private static final String TMP_PATH = 
    		System.getProperty("java.io.tmpdir");//플랫폼마다 임시폴더 달라 그걸 알아서 경로를 가지고 옴     
    private static final String TARGET_PATH = "D:\\study\\workspace\\ajax1\\WebContent\\WEB-INF\\addr";
    ...
    public static Map<String,Object> parseRequest(HttpServletRequest request) 
    	...
    	try {
			...
			for(FileItem file : fileList) {
				...
				if(file.isFormField()) { // 파일아닌거는다 true
    ...
    public static File writeFile(FileItem file) throws Exception {
    	...
    	// 절대경로 D:\\study\\workspace\\ajax1\\WebContent\\WEB-INF\\addr\\jibun_jeonnam.txt
